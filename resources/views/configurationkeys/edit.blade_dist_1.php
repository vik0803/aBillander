...
{{ Form::model($tax, array('method' => 'PATCH', 'route' => array('admin.taxes.update', $tax->id), 'class' => 'form-horizontal')) }}
	...
	<div class="content">
		...
		@endif
			...
			<div class="control-group">
				...
				<div class="controls">
					{{ Form::text('name', $tax->name, array('id' => 'name')) }}
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					{{ Form::text('percent', $tax->percent, array('id' => 'percent', 'class' => 'input-small')) }}
				</div>
			</div>
